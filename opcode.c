...
int disasm_RRR_RM (BYTE inst[], char mnemonic[], char *p)               /*810*/
{
DISASM_COMMON_VARS;
int r1,r2,r3,m4;
    r3 = inst[2] >> 4;
...
// RRR instructions with an alternate RRR_RM format                     /*810*/
int disasm_RRR_RMA (BYTE inst[], char mnemonic[], char *p)              /*810*/
{
DISASM_COMMON_VARS;
int r1,r2,r3,m4;
    r3 = inst[2] >> 4;
...
DLL_EXPORT zz_func opcode_b3xx[256][GEN_MAXARCH] = {
 ...
 /*B3D0*/ GENx___x390x900 (multiply_dfp_long_reg,RRR_RMA,"MDTR"),
 /*B3D1*/ GENx___x390x900 (divide_dfp_long_reg,RRR_RMA,"DDTR"),
 /*B3D2*/ GENx___x390x900 (add_dfp_long_reg,RRR_RMA,"ADTR"),
 /*B3D3*/ GENx___x390x900 (subtract_dfp_long_reg,RRR_RMA,"SDTR"),
 ...
 /*B3D8*/ GENx___x390x900 (multiply_dfp_ext_reg,RRR_RMA,"MXTR"),
 /*B3D9*/ GENx___x390x900 (divide_dfp_ext_reg,RRR_RMA,"DXTR"),
 /*B3DA*/ GENx___x390x900 (add_dfp_ext_reg,RRR_RMA,"AXTR"),
 /*B3DB*/ GENx___x390x900 (subtract_dfp_ext_reg,RRR_RMA,"SXTR"),
